...
// Ícones para as condições tratadas - Cinza e Rosa
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="fixed top-0 w-full backdrop-blur-md border-b border-gray-200/50 z-50 transition-all duration-300" style={{backgroundColor: '#f8fafc99'}}>
        <nav className="container mx-auto px-6 py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#especialidades" className="text-gray-700 hover:text-pink-500 transition-colors font-medium">Especialidades</a>
              <a href="#sobre" className="text-gray-700 hover:text-pink-500 transition-colors font-medium">Sobre</a>
              <button
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'animate-slideInLeft' : 'opacity-0'}`}>
              <div className="inline-flex items-center px-4 py-2 bg-gray-100/90 backdrop-blur-sm rounded-full mb-6">
                <CertificationIcon />
                <span className="ml-2 text-gray-700 font-medium text-sm">Hipnoterapeuta Certificada</span>
              </div>
            ...
            <div className="relative animate-fadeIn max-w-sm mx-auto">
              <div className="bg-white rounded-3xl p-6 shadow-2xl animate-subtleFloat border border-gray-200">
      ...
      {/* CTA Section Premium */}
      <section className="section-padding bg-gradient-to-r from-gray-700 via-pink-600 to-pink-700 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <button
                onClick={openWhatsApp}
                className="bg-white text-gray-700 hover:bg-gray-100 text-xl px-12 py-4 rounded-xl transition-all duration-300 hover:scale-105 font-semibold inline-flex items-center justify-center"
              >
